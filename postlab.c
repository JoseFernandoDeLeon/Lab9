...
void __interrupt() isr (void)
{
    ...
    {
        counter++;
        if (counter < pot3_val)  // Si el valor del contador es menor al de la conversión del Pot, encender LED
            PORTDbits.RD0 = 1;
        else
            PORTDbits.RD0 = 0;
        TMR0 = 6;
...
void setup (void){
    ...
    TRISD = 0;                  // PORTD como salida analógica
    ...
    TMR0 = 6;                  // Reiniciamos el TIMER0 a 6 para tener un retardo de 2ms
